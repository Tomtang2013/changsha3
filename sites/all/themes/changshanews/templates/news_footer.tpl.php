...
<div class="news_footer">
    <div class="container">
        ...
        <div class="row">
        <div class="friend_link  col-md-4 col-sm-6">
                <div class="footer_item" style="float:left;">友情链接</div>
                <div class="footer_item"><a href=""><img class="friend_link_img" style=" width: 50px;height: 29px;" src="<?php print $base_path.drupal_get_path('theme', 'changshanews'); ?>/images/footer/group01.png" alt=""></a></div>
                <div class="footer_item"><a href=""><img class="friend_link_img" style=" width: 80px;height: 29px;" src="<?php print $base_path.drupal_get_path('theme', 'changshanews'); ?>/images/footer/group02.png" alt=""></a></div>
            </div>
            <div class="new_media  col-md-4 col-sm-6">
                <div class="footer_item">新媒体</div>
                <div class="footer_item"><a href=""><img class="new_media_img" src="<?php print $base_path.drupal_get_path('theme', 'changshanews'); ?>/images/footer/wb.png" alt=""></a></div>
