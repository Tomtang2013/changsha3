        ...
        <div class="row ">
            <div class="right col-lg-8 col-md-8 col-xs-8">
                <div class="right_content">
                    <div><p> 恒嘉地产（泊富商业广场）、湘江锦绣、湘域相遇等</p>
                    <p> 酒鬼酒、金健米业、邵阳大曲、黄山头、泸州老窖、烟京啤酒等</p>
                    <p> 广汽本田、比亚迪、仁孚汽车、永通汽车等</p>
                    <p> 长沙银行、中国农业银行、中信银行、华融湘江银行、北京银行等</p>
                    <p> 中南出版传媒集团、中联重科股份有限公司、加加集团股份有限公司、湖南顺鑫干混砂浆有限公司、海上1930茶餐厅等</p>
                    </div>
                </div>
            </div>
            <div class="left col-lg-3  col-md-3 col-xs-3">
